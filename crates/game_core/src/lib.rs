...
pub use state::{
    ...
    RelationshipStatus, ResearchState, RoleModifiers, ScenarioSetup, ScoutMission, Sector,
    SectorId, ShipDesignId, ShipDesignRecord, SlotCategory, SpectralClass, Star, StarId,

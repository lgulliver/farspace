...
pub use state::{
    ...
    FleetKind, FleetLocation, FleetMission, GameState, OrbitalStructureType, Planet, PlanetSize,
    RelationshipStatus, ResearchState, ScoutMission, SpectralClass, Star, StarId, TechId,
    TechRecord,
};
